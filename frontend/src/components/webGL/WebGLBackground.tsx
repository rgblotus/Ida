...
import { generateParticleShape, type ParticleShape } from '../utils/shapeGenerators'
...
const WebGLBackground: React.FC<WebGLBackgroundProps> = ({
    ...
    const animate = useCallback(() => {
        ...
        system.points.rotation.y = elapsedTime * 0.05
        system.points.rotation.x = Math.sin(elapsedTime * 0.1) * 0.5
